...
graph <- function(){
par(mfrow=c(4,1))
plot(bsc_data$threshold,bsc_data$retained_loci, xlab="", ylab="Retained loci", pch = 19, col="#CC6600", type = "b", lty = 1, lwd = 2, xaxt='n') #2 BSC
...
plot(bsc_data$threshold,bsc_data$sum_var, xlab="", ylab="Sum VAR", pch = 19, col="#CC6600", type = "b", lty = 1, lwd = 2, xaxt='n') #4 BSC
...
plot(bsc_data$threshold,bsc_data$missing_snps, xlab="", ylab="% missing SNPs", pch = 19, col="#CC6600", type = "b", lty = 1, lwd = 2, xaxt='n') #6 BSC
...
plot(bsc_data$threshold,bsc_data$new_polymorphic_loci, xaxt = "n", ylab="New polimorphoc loci", xlab="BSC CT", pch = 19, col="#CC6600", type = "b", lty = 1, lwd = 2) 
